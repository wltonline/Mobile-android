...
/**
 * Created by lilian on 2017/8/22.
 */
    ...
    private void initData() {
        ...
        mAdapter.setOnItemClickListener(new PromotionAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                Toast.makeText(PromotionActivity.this,"click " + position + " item", Toast.LENGTH_SHORT).show();
            }

            @Override
            public void onItemLongClick(View view, int position) {
                Toast.makeText(PromotionActivity.this,"long click " + position + " item", Toast.LENGTH_SHORT).show();
            }
        });
    }
